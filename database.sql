...
-- Dumping data for table ecommerce.chats: ~22 rows (approximately)
DELETE FROM `chats`;
...
-- Dumping data for table ecommerce.general_settings: ~0 rows (approximately)
...
-- Dumping data for table ecommerce.logo_settings: ~0 rows (approximately)
...
-- Dumping data for table ecommerce.migrations: ~49 rows (approximately)
...
-- Dumping data for table ecommerce.password_reset_tokens: ~1 rows (approximately)
...
-- Dumping data for table ecommerce.product_variants: ~0 rows (approximately)
...
-- Dumping data for table ecommerce.pusher_settings: ~0 rows (approximately)
...
-- Dumping data for table ecommerce.transactions: ~4 rows (approximately)
...
-- Dumping data for table ecommerce.user_addresses: ~4 rows (approximately)
...
-- Dumping data for table ecommerce.wishlists: ~8 rows (approximately)
...
-- Dumping data for table ecommerce.withdraw_requests: ~0 rows (approximately)
